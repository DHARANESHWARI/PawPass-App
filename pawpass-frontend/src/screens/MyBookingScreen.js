...
import { View, Text, FlatList, StyleSheet, RefreshControl, ActivityIndicator, SafeAreaView, StatusBar } from 'react-native';
...
const MyBookingScreen = () => {
  ...
  const getStatusStyle = (status) => {
    switch(status) {
      ...
      case 'Checked-In': return { color: '#FBC02D', bg: '#FFFDE7' }; 
      case 'Completed': 
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      {/* Title moved further down with paddingTop: 50 */}
...
const styles = StyleSheet.create({
  ...
  title: { 
    ...
    paddingTop: 50, // Moved it down from the top edge
    paddingBottom: 20, 
    color: '#1A1A1A' 
  },
  ...
  rejectionBox: { backgroundColor: '#FFF9F9', padding: 15, borderRadius: 12, marginTop: 12, borderWidth: 1, borderColor: '#FFDADA', borderStyle: 'dashed' },
